...
import {
  Ed25519Keypair
} from "./chunk-P335ZE2P.js";
import "./chunk-EGRHWZRV.js";
import {
  SuiClient,
  getFullnodeUrl,
  isSuiClient
} from "./chunk-VUK7H2JF.js";
import "./chunk-7YUZOLRD.js";
import "./chunk-4ACF2H4S.js";
import {
  Transaction
} from "./chunk-SX3RAESB.js";
import {
  array,
  boolean,
  formatAddress,
...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React38 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState18 = React38.useState, useEffect20 = React38.useEffect, useLayoutEffect7 = React38.useLayoutEffect, useDebugValue2 = React38.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React38 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim.useSyncExternalStore, useRef18 = React38.useRef, useEffect20 = React38.useEffect, useMemo8 = React38.useMemo, useDebugValue2 = React38.useDebugValue;
...
var Portal = React13.forwardRef((props, forwardedRef) => {
  ...
  const container8 = containerProp || mounted && globalThis?.document?.body;
...
var PopperContent = React34.forwardRef(
  (props, forwardedRef) => {
    ...
    const [content4, setContent] = React34.useState(null);
...
var MenuPortal = (props) => {
  ...
  return (0, import_jsx_runtime14.jsx)(PortalProvider2, { scope: __scopeMenu, forceMount, children: (0, import_jsx_runtime14.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime14.jsx)(Portal, { asChild: true, container: container8, children }) }) });
};
...
function BackIcon(props) {
  return (0, import_jsx_runtime16.jsx)("svg", { width: 24, height: 24, fill: "none", xmlns: "http://www.w3.org/2000/svg", ...props, children: (0, import_jsx_runtime16.jsx)(
    "path",
    {
...
function CloseIcon(props) {
  return (0, import_jsx_runtime17.jsx)("svg", { width: 10, height: 10, fill: "none", xmlns: "http://www.w3.org/2000/svg", ...props, children: (0, import_jsx_runtime17.jsx)(
    "path",
    {
...
var StyleMarker = (0, import_react11.forwardRef)(({ children, ...props }, forwardedRef) => (0, import_jsx_runtime18.jsx)(Slot, { ref: forwardedRef, ...props, ...styleDataAttribute, children }));
  ...
  ({
    ...
    return (0, import_jsx_runtime19.jsx)(
      Slot,
      {
        ...
        children: asChild ? children : (0, import_jsx_runtime19.jsx)(Tag, { children })
      }
    );
  }
);
...
var IconButton = (0, import_react13.forwardRef)(
  ({ className, asChild = false, ...props }, forwardedRef) => {
    ...
    return (0, import_jsx_runtime20.jsx)(Comp, { ...props, className: clsx_default(container, className), ref: forwardedRef });
  }
);
  ...
  ({
    ...
    return (0, import_jsx_runtime22.jsx)(
      Slot,
      {
        ...
        children: asChild ? children : (0, import_jsx_runtime22.jsx)(Tag, { children })
      }
    );
  }
);
...
function ConnectionStatus({
  ...
  return (0, import_jsx_runtime23.jsxs)("div", { className: container2, children: [
    selectedWallet.icon && (0, import_jsx_runtime23.jsx)(
      "img",
      {
    ...
    (0, import_jsx_runtime23.jsx)("div", { className: title2, children: (0, import_jsx_runtime23.jsxs)(Heading, { as: "h2", size: "xl", children: [
      "Opening ",
      selectedWallet.name
    ] }) }),
    (0, import_jsx_runtime23.jsx)("div", { className: connectionStatus, children: hadConnectionError ? (0, import_jsx_runtime23.jsx)(Text, { color: "danger", children: "Connection failed" }) : (0, import_jsx_runtime23.jsx)(Text, { color: "muted", children: "Confirm connection in the wallet..." }) }),
    hadConnectionError ? (0, import_jsx_runtime23.jsx)("div", { className: retryButtonContainer, children: (0, import_jsx_runtime23.jsx)(Button, { type: "button", variant: "outline", onClick: () => onRetryConnection(selectedWallet), children: "Retry Connection" }) }) : null
  ] });
}
var container3 = "InfoSection_container__1wtioi70";
function InfoSection({ title: title3, children }) {
  return (0, import_jsx_runtime24.jsxs)("section", { className: container3, children: [
    (0, import_jsx_runtime24.jsx)(Heading, { as: "h3", size: "sm", weight: "normal", children: title3 }),
    (0, import_jsx_runtime24.jsx)(Text, { weight: "medium", color: "muted", children })
  ] });
}
...
function GettingStarted() {
  return (0, import_jsx_runtime25.jsxs)("div", { className: container4, children: [
    (0, import_jsx_runtime25.jsx)(Heading, { as: "h2", children: "Get Started with Sui" }),
    (0, import_jsx_runtime25.jsxs)("div", { className: content2, children: [
      (0, import_jsx_runtime25.jsx)(InfoSection, { title: "Install the Sui Wallet Extension", children: "We recommend pinning Sui Wallet to your taskbar for quicker access." }),
      (0, import_jsx_runtime25.jsx)(InfoSection, { title: "Create or Import a Wallet", children: "Be sure to back up your wallet using a secure method. Never share your secret phrase with anyone." }),
      (0, import_jsx_runtime25.jsx)(InfoSection, { title: "Refresh Your Browser", children: "Once you set up your wallet, refresh this window browser to load up the extension." }),
      (0, import_jsx_runtime25.jsx)("div", { className: installButtonContainer, children: (0, import_jsx_runtime25.jsx)(Button, { variant: "outline", asChild: true, children: (0, import_jsx_runtime25.jsx)(
        "a",
        {
...
function WhatIsAWallet() {
  return (0, import_jsx_runtime26.jsxs)("div", { className: container5, children: [
    (0, import_jsx_runtime26.jsx)(Heading, { as: "h2", children: "What is a Wallet" }),
    (0, import_jsx_runtime26.jsxs)("div", { className: content3, children: [
      (0, import_jsx_runtime26.jsx)(InfoSection, { title: "Easy Login", children: "No need to create new accounts and passwords for every website. Just connect your wallet and get going." }),
      (0, import_jsx_runtime26.jsx)(InfoSection, { title: "Store your Digital Assets", children: "Send, receive, store, and display your digital assets like NFTs & coins." })
    ] })
  ] });
}
function SuiIcon(props) {
  return (0, import_jsx_runtime27.jsxs)("svg", { width: 28, height: 28, fill: "none", xmlns: "http://www.w3.org/2000/svg", ...props, children: [
    (0, import_jsx_runtime27.jsx)("rect", { width: 28, height: 28, rx: 6, fill: "#6FBCF0" }),
...
function WalletListItem({ name, icon, onClick, isSelected = false }) {
  return (0, import_jsx_runtime28.jsx)("li", { className: container7, children: (0, import_jsx_runtime28.jsxs)(
    "button",
    {
      ...
      onClick,
      children: [
        icon && typeof icon === "string" ? (0, import_jsx_runtime28.jsx)("img", { className: walletIcon2, src: icon, alt: `${name} logo` }) : icon,
        (0, import_jsx_runtime28.jsx)(Heading, { size: "md", truncate: true, asChild: true, children: (0, import_jsx_runtime28.jsx)("div", { children: name }) })
      ]
    }
  ) });
}
function WalletList({
  ...
  return (0, import_jsx_runtime29.jsx)("ul", { className: container6, children: wallets2.length > 0 ? wallets2.map((wallet) => (0, import_jsx_runtime29.jsx)(
    WalletListItem,
    {
      name: wallet.name,
      icon: wallet.icon,
    ...
    {
      name: "Sui Wallet",
      icon: (0, import_jsx_runtime29.jsx)(SuiIcon, {}),
...
function ConnectModal({
  ...
  switch (currentView) {
    case "what-is-a-wallet":
      modalContent = (0, import_jsx_runtime30.jsx)(WhatIsAWallet, {});
      break;
    case "getting-started":
      modalContent = (0, import_jsx_runtime30.jsx)(GettingStarted, {});
      break;
    case "connection-status":
      modalContent = (0, import_jsx_runtime30.jsx)(
        ConnectionStatus,
        {
          selectedWallet,
  ...
  return (0, import_jsx_runtime30.jsxs)(Root, { open: open ?? isModalOpen, onOpenChange: handleOpenChange, children: [
    (0, import_jsx_runtime30.jsx)(Trigger, { asChild: true, children: trigger }),
    (0, import_jsx_runtime30.jsx)(Portal2, { children: (0, import_jsx_runtime30.jsx)(StyleMarker, { children: (0, import_jsx_runtime30.jsx)(Overlay, { className: overlay, children: (0, import_jsx_runtime30.jsxs)(Content, { className: content, "aria-describedby": void 0, children: [
      (0, import_jsx_runtime30.jsxs)(
        "div",
        {
          ...
          children: [
            (0, import_jsx_runtime30.jsxs)("div", { className: walletListContent, children: [
              (0, import_jsx_runtime30.jsx)(Title, { className: title, asChild: true, children: (0, import_jsx_runtime30.jsx)(Heading, { as: "h2", children: "Connect a Wallet" }) }),
      ...
      (0, import_jsx_runtime30.jsxs)(
        "div",
        {
          ...
          children: [
            (0, import_jsx_runtime30.jsx)("div", { className: backButtonContainer, children: (0, import_jsx_runtime30.jsx)(IconButton, { type: "button", "aria-label": "Back", onClick: () => resetSelection(), children: (0, import_jsx_runtime30.jsx)(BackIcon, {}) }) }),
            modalContent
          ]
        }
      ),
      (0, import_jsx_runtime30.jsx)(Close, { className: closeButtonContainer, asChild: true, children: (0, import_jsx_runtime30.jsx)(IconButton, { type: "button", "aria-label": "Close", children: (0, import_jsx_runtime30.jsx)(CloseIcon, {}) }) })
    ] }) }) }) })
  ] });
}
...
function SuiClientProvider(props) {
  ...
  return (0, import_jsx_runtime31.jsx)(SuiClientContext.Provider, { value: ctx, children });
}
...
function CheckIcon(props) {
  return (0, import_jsx_runtime32.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "none", ...props, children: (0, import_jsx_runtime32.jsx)(
    "path",
    {
      fill: "currentColor",
...
function ChevronIcon(props) {
  return (0, import_jsx_runtime33.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", width: 16, height: 16, fill: "none", ...props, children: (0, import_jsx_runtime33.jsx)(
    "path",
    {
      stroke: "#A0B6C3",
      strokeLinecap: "round",
...
function AccountDropdownMenu({ currentAccount }) {
  ...
  return (0, import_jsx_runtime34.jsxs)(Root23, { modal: false, children: [
    (0, import_jsx_runtime34.jsx)(StyleMarker, { children: (0, import_jsx_runtime34.jsx)(Trigger2, { asChild: true, children: (0, import_jsx_runtime34.jsxs)(Button, { size: "lg", className: connectedAccount, children: [
      (0, import_jsx_runtime34.jsx)(Text, { mono: true, weight: "bold", children: currentAccount.label ?? domain ?? formatAddress(currentAccount.address) }),
      (0, import_jsx_runtime34.jsx)(ChevronIcon, {})
    ] }) }) }),
    (0, import_jsx_runtime34.jsx)(Portal22, { children: (0, import_jsx_runtime34.jsx)(StyleMarker, { className: menuContainer, children: (0, import_jsx_runtime34.jsxs)(Content23, { className: menuContent, children: [
      accounts.map((account) => (0, import_jsx_runtime34.jsx)(
      ...
      (0, import_jsx_runtime34.jsx)(Separator2, { className: separator }),
...
function AccountDropdownMenuItem({
  ...
  return (0, import_jsx_runtime34.jsxs)(
    Item22,
    {
      ...
      children: [
        (0, import_jsx_runtime34.jsx)(Text, { mono: true, children: account.label ?? domain ?? formatAddress(account.address) }),
        active ? (0, import_jsx_runtime34.jsx)(CheckIcon, {}) : null
      ]
    }
  );
}
function ConnectButton({
  ...
  return currentAccount ? (0, import_jsx_runtime35.jsx)(AccountDropdownMenu, { currentAccount }) : (0, import_jsx_runtime35.jsx)(
    ConnectModal,
    {
      walletFilter,
      trigger: (0, import_jsx_runtime35.jsx)(StyleMarker, { children: (0, import_jsx_runtime35.jsx)(Button, { ...buttonProps, children: connectText }) })
    }
  );
}
...
function WalletProvider({
  ...
  return (0, import_jsx_runtime37.jsx)(WalletContext.Provider, { value: storeRef.current, children: (0, import_jsx_runtime37.jsxs)(
    WalletConnectionManager,
    {
      ...
      slushWallet,
      children: [
        theme ? (0, import_jsx_runtime37.jsx)(InjectedThemeStyles, { theme }) : null,
        children
      ]
    }
  ) });
